...
PGGB concludes with tools that generate 1D and 2D visualizations of the graph and its embedded paths, using the graph genome toolkit ODGI~\cite{Guarracino2022}.
