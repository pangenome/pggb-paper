...
\title[Reference-free pangenome graphs]{Reference-free pangenome graphs}
...
\abstract{
    Advances in genome assembly have greatly reduced the cost and effort of obtaining Telomere-to-Telomere (T2T) genome assemblies, but their unbiased analysis remains difficult.
    In response to the future abundance of high-quality T2T assemblies, we propose the PanGenome Graph Builder (PGGB), a reference-free pangenome construction pipeline.
...
\keywords{pangenome graphs, pangenomics, comparative genomics}
