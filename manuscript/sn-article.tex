...
Futhermore, to apply a minigraph-base approach, researchers had to mask new satellite sequences, as well as newly assembled regions on the acrocentric p-arms. %fixme citation?
...
%fixme minigraph is also reference-biased
