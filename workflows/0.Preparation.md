...
cp build/bin/wfmash build/bin/wfmash-2b42cba6a6623d7838605679dbce73b6fc2bde33
cd ..
...
cd pggb
git checkout master && git pull && git submodule update --init --recursive
git checkout fde3211745d5ec6c32f7cba1ddfd3e2fc4511e7f
cp pggb pggb-x
sed 's,"$fmt" wfmash,"$fmt" ~/tools/wfmash/build/bin/wfmash-2b42cba6a6623d7838605679dbce73b6fc2bde33,g' pggb-x -i
sed 's,$(wfmash,$(~/tools/wfmash/build/bin/wfmash-2b42cba6a6623d7838605679dbce73b6fc2bde33,g' pggb-x -i
...
mv pggb-x pggb-fde3211745d5ec6c32f7cba1ddfd3e2fc4511e7f
cp partition-before-pggb partition-before-pggb-x
sed 's,"$fmt" wfmash,"$fmt" ~/tools/wfmash/build/bin/wfmash-2b42cba6a6623d7838605679dbce73b6fc2bde33,g' partition-before-pggb-x -i
sed 's,$(wfmash,$(~/tools/wfmash/build/bin/wfmash-2b42cba6a6623d7838605679dbce73b6fc2bde33,g' partition-before-pggb-x -i
...
mv partition-before-pggb-x partition-before-pggb-fde3211745d5ec6c32f7cba1ddfd3e2fc4511e7f
cd ..
...
wget -c https://s3-us-west-2.amazonaws.com/human-pangenomics/T2T/HG002/assemblies/hg002v1.0.fasta
sed -e 's/^>chr\(.*\)_MATERNAL/>hg002#M#chr\1_MATERNAL/' \
    -e 's/^>chr\(.*\)_PATERNAL/>hg002#P#chr\1_PATERNAL/' \
    -e 's/^>chrEBV/>hg002#P#chrEBV/' \
    -e 's/^>chrM/>hg002#M#chrM/' hg002v1.0.fasta | bgzip -@ 48 -l 9 > hg002v1.fa.gz && samtools faidx hg002v1.fa.gz
rm hg002v1.0.fasta

zcat chm13v2.0.fa.gz mGorGor1.fa.gz mPanPan1.fa.gz mPanTro3.fa.gz mPonAbe1.fa.gz mPonPyg2.fa.gz mSymSyn1.fa.gz | bgzip -@ 48 -l 9 > primates13.20231122.fa.gz && samtools faidx primates13.20231122.fa.gz
zcat chm13v2.0.fa.gz hg002v1.fa.gz mGorGor1.fa.gz mPanPan1.fa.gz mPanTro3.fa.gz mPonAbe1.fa.gz mPonPyg2.fa.gz mSymSyn1.fa.gz | bgzip -@ 48 -l 9 > primates15.20231122.fa.gz && samtools faidx primates15.20231122.fa.gz
zcat chm13v2.0.fa.gz grch38.fa.gz hg002v1.fa.gz mGorGor1.fa.gz mPanPan1.fa.gz mPanTro3.fa.gz mPonAbe1.fa.gz mPonPyg2.fa.gz mSymSyn1.fa.gz | bgzip -@ 48 -l 9 > primates16.20231122.fa.gz && samtools faidx primates16.20231122.fa.gz
...
cat \
  ...
  <(samtools faidx hg002v1.fa.gz hg002#M#chr6_MATERNAL hg002#P#chr6_PATERNAL) \
...
```shell
mkdir -p $DIR_BASE/assemblies/sars_cov_2
cd $DIR_BASE/assemblies/sars_cov_2

cp $DIR_BASE/data/accession_numbers.SARS-CoV-2.txt .
cp $DIR_BASE/data/download_SARS-CoV-2.sh .
```
