...
WFMASH=/home/guarracino/tools/wfmash/build/bin/wfmash-180455df2aaa298fbe2dafb1ddfc2796c78b3fcd
```
...
cp build/bin/wfmash build/bin/wfmash-180455df2aaa298fbe2dafb1ddfc2796c78b3fcd
cd ..
...
cd pggb
git checkout master && git pull && git submodule update --init --recursive
git checkout 97979e52796a6ac8a40d63e0a18c82615f606076
cp pggb pggb-x
sed 's,"$fmt" wfmash,"$fmt" ~/tools/wfmash/build/bin/wfmash-180455df2aaa298fbe2dafb1ddfc2796c78b3fcd,g' pggb-x -i
sed 's,$(wfmash,$(~/tools/wfmash/build/bin/wfmash-180455df2aaa298fbe2dafb1ddfc2796c78b3fcd,g' pggb-x -i
...
mv pggb-x pggb-97979e52796a6ac8a40d63e0a18c82615f606076
cp partition-before-pggb partition-before-pggb-x
sed 's,"$fmt" wfmash,"$fmt" ~/tools/wfmash/build/bin/wfmash-180455df2aaa298fbe2dafb1ddfc2796c78b3fcd,g' partition-before-pggb-x -i
sed 's,$(wfmash,$(~/tools/wfmash/build/bin/wfmash-180455df2aaa298fbe2dafb1ddfc2796c78b3fcd,g' partition-before-pggb-x -i
...
mv partition-before-pggb-x partition-before-pggb-97979e52796a6ac8a40d63e0a18c82615f606076
cd ..
