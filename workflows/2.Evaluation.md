...
grep 'athaliana\|tomato\|soy' nucmer-based_evaluation.waved.mean.tsv | grep athaliana82 | grep p95.s5000.n82.k47.G700-900-1100.Pasm5.O0001 | awk '
    BEGIN { FS=OFS="\t" }
    {
        # Sum columns
...
for f in athaliana82.p95.s5000.n82.k47.G700-900-1100.Pasm5.O0001_1; do
