...
ls $DIR_GRAPHS/primates16.hsa6_p9*/*.og | while read GRAPH; do
  ...
  sbatch -c 48 -p workers -J $NAME --wrap "hostname; $ODGI layout -i $PREFIX.og --layout-initialization h -x 300 -G 20 -I 10000 -l 1000 -o $PREFIX.lay -T $PREFIX.lay.tsv -t 48 -P --temp-dir /scratch/; $ODGI draw -i $PREFIX.og -c $PREFIX.lay -p $NAME.2D.png"
done
```
