...
cd $DIR_GRAPHS/hsapiens90.chr6.masked_p98.s20000.n90.k47.G700-900-1100.Pasm5.O0001_1

# GFA to ODGI
ls *gfa| grep -E "k0\.gfa$|k47\.gfa$" | while read GRAPH; do echo $GRAPH; odgi build -g $GRAPH -o $(basename $GRAPH .gfa).og -t 32; done  

# Stats
ls *.og | grep C4 -v | while read GRAPH; do echo $GRAPH; odgi stats -i $GRAPH -S; done       
...
# ALSO ON ATHALIANA!?!?!?!?
ls *.og | grep C4 -v | while read GRAPH; do
  echo $GRAPH;
  NAME=$(basename $GRAPH .og)
  odgi depth -i $GRAPH -b hsapiens90.chr6.masked.chm13.windows.10kbp.bed | bedtools sort > $NAME.depth.tsv
done
