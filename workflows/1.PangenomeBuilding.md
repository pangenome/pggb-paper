...
# soy 1 2 3 4 5 6 7 8 9 14p90s10000 15 16 17 19 20
...
sed '1d' $PATH_PANGENOMES_TSV | grep 'athaliana82\|tomato23\|soy37' -v | grep mmusculus -v | grep scerevisiae | cut -f 1 -d ' ' | sort | uniq | while read PATH_FASTA; do
  DIR_PANGENOME="$(dirname $PATH_FASTA)"
